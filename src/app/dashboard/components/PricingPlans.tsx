...
const defaultPlans: Plan[] = [
  {
    ...
    features: ['Tienda básica con subdominio .emprendy', 'CRM básico', 'Soporte por email'],
    popular: false,
  ...
  },
  {
    ...
    features: ['Todo lo incluido en Basic', 'Chatbot WhatsApp', 'CRM avanzado'],
    popular: true,
  ...
  },
  {
    ...
    features: ['Todo lo incluido en Pro', 'Gestor de cuenta dedicado'],
    popular: false,
